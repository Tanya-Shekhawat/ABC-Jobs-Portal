...
<body>
            ...
            <div class="box" style="height: 30cm; width: 50cm;">
               <h1>Job Applied Successfully</h1>
               <p>Congratulations!! Job applied successfully<br></br>
                Best of luck for next step<br></br>
                Click <a href="/user" style="color: yellow; text-decoration: none;">here</a> to go back home</p>
               <div class="pyro">
