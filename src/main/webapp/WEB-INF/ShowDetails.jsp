...
<h1 style="padding-left: 49%; margin-top:9%; ">User's Details</h1>
...
<dd:forEach var="lear" items="${testv}">
    <tr>
    <td>${lear.userId}</td>
    <td>${lear.firstName}</td>
    <td>${lear.lastName}</td>
    <td>${lear.mailid}</td>
    <td>${lear.userContact}</td>
    <td>${lear.userAddress}</td>
    <td>${lear.userName}</td>
    <td><a href="update/${lear.userId}">Edit</a></td>
    <td ><a href="/delete/${lear.userId}">Delete</a></td>
    </tr>
</dd:forEach>
</tbody>
</Table>
