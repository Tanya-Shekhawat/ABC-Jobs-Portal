...
<fm:form action="/deletejob/${apply.job_Id}" method="get" modelAttribute="apply" >
...
<a href="/deletejob/${apply.job_Id}"><button class="apbtn">Delete Job</button></a>
</div>
<div class="bottom"></div>
</fm:form>
<a href="/viewjobsadmin"><button class="button">Go Back</button></a>
<div class="bottom"></div>  
</div>
